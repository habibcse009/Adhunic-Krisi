package com.project.adunik_krisi.Admin.Profile;
...
public class EditProfileAdminActivity extends AppCompatActivity {
    ...
    public void UpdateProfile() {
        ...
        if (name.isEmpty()) {
            extUsernameAdmn.setError("নামের ঘর খালি হতে পারে না!");
            extUsernameAdmn.requestFocus();
        } else if (mobile.length() != 11) {
            extMobileAdmn.setError("মোবাইল নাম্বার ভুল!");
            extMobileAdmn.requestFocus();

        } else if (email.isEmpty()) {
            extEmailAdmn.setError("ইমেইলের ঘর খালি হতে পারে না!");
            extEmailAdmn.requestFocus();
        } else if (password.length() < 4) {
            extPasswordAdmn.setError("পাসওয়ার্ড অনেক ছোট কিংবা ভুল !");
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equals("success")) {
                                ...
                                Toasty.success(EditProfileAdminActivity.this, "প্রোফাইল সঠিকভাবে হালনাগাদ হয়েছে!", Toast.LENGTH_SHORT).show();
                            ...
                            //If we are getting success from server
                                ...
                                Intent intent = new Intent(EditProfileAdminActivity.this, ProfileAdminActivity.class);
                                Toasty.error(EditProfileAdminActivity.this, "প্রোফাইল হালনাগাদ ব্যার্থ!", Toast.LENGTH_SHORT).show();
                                //startActivity(intent);

                            } else {

                                loading.dismiss();
                                Toasty.error(EditProfileAdminActivity.this, "নেটওয়ার্কের সমস্যা", Toast.LENGTH_SHORT).show();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toasty.error(EditProfileAdminActivity.this, "ইন্টারনেট কানেকশন নেই অথবা \nএখানে কোন একটা সমস্যা আছে !!!", Toast.LENGTH_LONG).show();
                            loading.dismiss();
                        }
                    }) {
