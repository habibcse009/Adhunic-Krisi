...
public class FarmersListAdminActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmers_list_admin);

        CustomList = findViewById(R.id.listView_Farmer);
        //  btnSearch = findViewById(R.id.btnSearch_user);
        etxtSearch = findViewById(R.id.etxt_search_Farmer);
    ...
    /*    btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(FarmersListAdminActivity.this, "Please input customer name!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(FarmersListAdminActivity.this, "ইন্টারনেট কানেকশন নেই!", Toast.LENGTH_LONG).show();
                    }
                });
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(FarmersListAdminActivity.this, "ইন্টারনেট কানেকশন নেই!", Toast.LENGTH_SHORT).show();
                    }
                });

        RequestQueue requestQueue = Volley.newRequestQueue(FarmersListAdminActivity.this);
        requestQueue.add(stringRequest);
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(FarmersListAdminActivity.this, "কোন কৃষকের তথ্য পাওয়া যায় নী!", Toast.LENGTH_SHORT).show();
        ...
        ListAdapter adapter = new SimpleAdapter(
                FarmersListAdminActivity.this, list, R.layout.farmer_list_item,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                new AlertDialog.Builder(FarmersListAdminActivity.this)
                        ...
                        .setNegativeButton("একাউন্ট ডিলিট করুন", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //write here
                                new androidx.appcompat.app.AlertDialog.Builder(FarmersListAdminActivity.this)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (getResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(FarmersListAdminActivity.this, AdminMainActivity.class);
                            Toasty.success(FarmersListAdminActivity.this, " একাউন্ট ডিলিট সম্পন্ন!", Toast.LENGTH_SHORT).show();
                        ...
                        //If we are getting success from server
                            ...
                            Toast.makeText(FarmersListAdminActivity.this, "একাউন্ট ডিলিট ব্যার্থ!", Toast.LENGTH_SHORT).show();
                            //startActivity(intent);

                        } else {

                            loading.dismiss();
                            Toast.makeText(FarmersListAdminActivity.this, "নেটওয়ার্কের সমস্যা", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(FarmersListAdminActivity.this, "ইন্টারনেট কানেকশন নেই অথবা \nএখানে কোন একটা সমস্যা আছে !!!", Toast.LENGTH_LONG).show();
                        loading.dismiss();
                    }
                }) {
